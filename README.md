...
[![tests](https://img.shields.io/badge/tests-349-brightgreen.svg)](tests/test_frozen_invariants.py)
...
- **349 automated checks** fail the build if the words and the data stop agreeing. They have caught us five times, including once when we published a number with the wrong sign.
