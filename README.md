...
[![tests](https://img.shields.io/badge/tests-172-brightgreen.svg)](tests/test_frozen_invariants.py)
...
Six evaluations. Four came back negative. All six are reported.
...
- **172 automated checks** fail the build if the words and the data stop agreeing. They have caught us five times, including once when we published a number with the wrong sign.
