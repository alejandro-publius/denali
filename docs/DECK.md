...
|---:|---|---|---|
| 0 | OPEN | Title card 1 — *thirteen evaluations · nine negative · all thirteen reported* | — |
...
|---|---|---|
| **1 · Open** | `THIRTEEN EVALUATIONS` / `NINE NEGATIVE` / `ALL THIRTEEN REPORTED` | The page opens on the finding; the talk opens on the posture. |
...
"nine of thirteen came back negative" and stops scrubbing.

### Checklist before upload

- [ ] Under 3:00
- [ ] The halt is visible and un-cut in beat 2
- [ ] "Nine of thirteen" is audible in the first 15 seconds and the last 15
...
- **No roadmap slide.** Thirteen evaluations with nine negatives is the claim. A future-work slide invites "so it doesn't work yet."
