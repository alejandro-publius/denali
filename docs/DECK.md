...
|---:|---|---|---|
| 0 | OPEN | Title card 1 — *fourteen evaluations · ten negative · all thirteen reported* | — |
...
|---|---|---|
| **1 · Open** | `FOURTEEN EVALUATIONS` / `TEN NEGATIVE` / `ALL FOURTEEN REPORTED` | The page opens on the finding; the talk opens on the posture. |
...
"ten of fourteen came back negative" and stops scrubbing.

### Checklist before upload

- [ ] Under 3:00
- [ ] The halt is visible and un-cut in beat 2
- [ ] "Ten of fourteen" is audible in the first 15 seconds and the last 15
...
- **No roadmap slide.** Fourteen evaluations with ten negatives is the claim. A future-work slide invites "so it doesn't work yet."
