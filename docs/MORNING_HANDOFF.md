...
- MCP server wired to a client: started over stdio from /tmp, 4 tools listed, 12 calls returned non-empty (2 lookups into our result, plus audit/rerank on the caller's own data)
