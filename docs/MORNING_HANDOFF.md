...
- MCP server wired to a client: started over stdio from /tmp, 5 tools listed, 11 calls returned non-empty (2 lookups into our result, plus audit/rerank/baseline on the caller's own data)
