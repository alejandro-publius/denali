...
The study behind it ran **fourteen evaluations** against its own headline. **Seven came
back negative**, one returned no verdict when its own pre-registered power rule fired,
and all fourteen are reported — including the one where the same check was run on 1,272
